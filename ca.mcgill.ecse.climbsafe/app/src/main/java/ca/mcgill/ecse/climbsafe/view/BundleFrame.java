...
public class BundleFrame extends JFrame {
		...
		layout.setHorizontalGroup(layout.createParallelGroup().addComponent(errorMessage)
				...
				.addGroup(layout.createSequentialGroup()
						...
						.addGroup(layout.createParallelGroup().addComponent(bundleNameTextField, 200, 200, 400)
								...
								.addComponent(addBundleButton).addComponent(oldNameList)
								.addComponent(bundleNewNameTextField, 200, 200, 400).addComponent(itemNewBox)
								.addComponent(itemNewQTextField, 200, 200, 400).addComponent(addUpdatedItemButton)
								.addComponent(bundleNewDiscounttTextField, 200, 200, 400)
								.addComponent(updatebundleButton).addComponent(deletebundleButton)
								.addComponent(nameToDeleteList).addComponent(previousPage))
	...
	private void addUpdatedItemActionPerformed(ActionEvent evt) {
		...
		if (bundleNewNameTextField.getText().equals("") || bundleNewDiscounttTextField.getText().equals("")
				|| bName == "") {
			error = "Please fill all fields!";
		}
