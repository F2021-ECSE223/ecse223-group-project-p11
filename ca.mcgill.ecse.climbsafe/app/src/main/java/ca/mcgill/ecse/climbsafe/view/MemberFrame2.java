...
public class MemberFrame2 extends JFrame {
	...
	private void initComponents() {
		...
		layout.setVerticalGroup(layout.createSequentialGroup().addComponent(errorMessage)
				...
				).addComponent(midLine).addGroup(layout.createParallelGroup().addComponent(updateMemberButton)).addComponent(previousPage)
	...
	private void backToPreviousPage(ActionEvent evt) {
		HomePageMemberFrame homepage = new HomePageMemberFrame(currentUser);
