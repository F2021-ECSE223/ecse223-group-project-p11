...
public class Assignment
{
  ...
  public Assignment(Date aReservationStartDate, Date aReservationEndDate, Booking aBooking, ClimbSafe aClimbSafe, ClimbingWeek... allAssignedWeeks)
  {
  ...
  public Assignment(Date aReservationStartDate, Date aReservationEndDate, int aNumOfWeeksForBooking, boolean aWantsGuideForBooking, boolean aWantsHotelForBooking, int aTotalCostForBooking, ClimbSafe aClimbSafeForBooking, Climber aClimberForBooking, ClimbSafe aClimbSafe, ClimbingWeek... allAssignedWeeks)
  {
    reservationStartDate = aReservationStartDate;
    reservationEndDate = aReservationEndDate;
    assignedWeeks = new ArrayList<ClimbingWeek>();
