...
public class Booking
{
  ...
  public Booking(int aNumOfWeeks, boolean aWantsGuide, boolean aWantsHotel, int aTotalCost, ClimbSafe aClimbSafe, String aEmailForClimber, String aPasswordForClimber, ClimbSafe aClimbSafeForClimber, String aNameForClimber, int aEmergencyPhoneNumberForClimber, Date aReservationStartDateForAssignment, Date aReservationEndDateForAssignment, ClimbSafe aClimbSafeForAssignment, ClimbingWeek... allAssignedWeeksForAssignment)
  {
    numOfWeeks = aNumOfWeeks;
    wantsGuide = aWantsGuide;
    wantsHotel = aWantsHotel;
    ...
    assignment = new Assignment(aReservationStartDateForAssignment, aReservationEndDateForAssignment, this, aClimbSafeForAssignment, allAssignedWeeksForAssignment);
  }
  ...
  /**
   * details on the computation are given in the project report
   */
