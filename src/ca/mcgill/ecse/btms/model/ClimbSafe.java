...
public class ClimbSafe
{
  ...
  /* Code from template association_AddManyToOne */
  public Assignment addAssignment(Date aReservationEndDate, Booking aBooking, ClimbingWeek... allAssignedWeeks)
  {
    return new Assignment(aReservationEndDate, aBooking, this, allAssignedWeeks);
  }
